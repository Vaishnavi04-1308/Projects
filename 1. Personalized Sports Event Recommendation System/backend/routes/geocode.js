...
for (let index = 0; index < req.body.events.length; index++) {
  ...
  await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${element.address?element.address:element.location}&key=AIzaSyA8W5ENK4ZFTgdM1DCJNJk51CxbHSjMOOc`,{mode:'cors',headers:{
